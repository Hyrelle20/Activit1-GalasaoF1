...
const char* ssid = "Hyrelle";
const char* password = "soperganda";
...
void sequenceOne() { clearLEDs(); digitalWrite(14, HIGH); delay(250); }
void sequenceTwo() { clearLEDs(); digitalWrite(27, HIGH); digitalWrite(12, HIGH); delay(250); }
void sequenceThree() { clearLEDs(); digitalWrite(33, HIGH); digitalWrite(13, HIGH); delay(250); }